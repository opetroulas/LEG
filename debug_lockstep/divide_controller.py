...
"""
This file runs debugy.py in parallel over many divisions of a single program.
Large programs including linux can be split up and debugged in parallel using
this script.

See parallel-divisions.txt for an example of a division file for linux.
It includes the instruction start and stop addresses for each division.
"""
...
def load_divisions(divfile):
	...
	js  = [] # List of jumps and steps (see debug.py run_js for more info)
